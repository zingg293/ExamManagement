namespace DPD.HR.Infrastructure.Validation.Models.PolicticialInformationEmployee
{
    public class PolicticialInformationEmployeeModel
    {
            ...
            public string? PartyMembershipCardCommittee { get; set; }
